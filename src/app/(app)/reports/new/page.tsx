                    ...
                    {loadingFellows ? (
                      ...
                      <SearchableSelect
                        ...
                        onChange={(val) => {
                          ...
                          const matchedFellow = assignedFellows.find(af => af.name === val);
                          if (matchedFellow) {
              ...
              {evidence.map((ev, i) => (
                <div key={i} className="flex flex-col gap-1">
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <a href={ev.url} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline truncate max-w-md">
                      {ev.url.split("/").pop()}
                    </a>
                    <button
                      type="button"
